...
\geometry{left=0.75cm, top=.8cm, right=0.75cm, bottom=1.8cm, footskip=0.5cm}
...
\name{Christopher}{Young}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{7 Bee St, Apt B, Charleston SC, 29403}

\mobile{(843) 443-7903}
\email{christopher98young@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{themagicalmammal.vercel.app} 
\github{ChrisRobYoung}
\linkedin{ChrisRobYoung}
% \gitlab{gitlab-id}
